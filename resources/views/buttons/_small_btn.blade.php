    ...
    <button type="button" class="btn btn-success col-12 mb-lg-0 pt-2 small__btn button__to" data-toggle="modal" data-target="#staticBackdrop">
        <span class="d-inline-flex m__top">
