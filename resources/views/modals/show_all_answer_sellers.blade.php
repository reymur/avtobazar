...
<!-- Modal -->
<div class="modal fade" id="show_all_sellers-{{ $answer->id }}" tabindex="-1" aria-labelledby="show_all_sellers" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="show_all_sellers-{{ $answer->id }}">
                    <span class="mr-0">
            ...
            <div class="modal-body pt-2 pb-1">
                <table class="table table-bordered">
                    ...
                    @foreach( $answer->user as $seller )
                        <tr>
                            <td class="py-2">
                                <a href="{{ $seller->id }}" class="col-12 d-inline-flex pr-1" data-toggle="modal" data-target="#show-{{ $seller->id }}">
