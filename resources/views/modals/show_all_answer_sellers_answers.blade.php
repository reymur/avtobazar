...
<!-- Modal -->
<div class="modal fade z__index-1" id="show-{{ $seller->id }}" tabindex="-1" aria-labelledby="show-{{ $seller->id }}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content show__sellers-answers">
            <div class="modal-header">
                <h5 class="modal-title" id="show-{{ $seller->id }}">
                    <span class="mr-0">
